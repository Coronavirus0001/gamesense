...
client.set_event_callback("shutdown", function()
    ui.set_visible(antiaim.pitch, true)
    ui.set_visible(antiaim.yaw_base, true)
    ui.set_visible(antiaim.yaw[1], true)
    ui.set_visible(antiaim.yaw[2], true)
    ui.set_visible(antiaim.yaw_jitter[1], true)
    ui.set_visible(antiaim.yaw_jitter[2], true)
    ui.set_visible(antiaim.body_yaw[1], true)
    ui.set_visible(antiaim.body_yaw[2], true)
    ui.set_visible(antiaim.freestanding_body_yaw, true)
    ui.set_visible(antiaim.fake_yaw_limit, true)
    ui.set_visible(antiaim.edge_yaw, true)
    ui.set_visible(antiaim.freestanding[1], true)
    ui.set_visible(antiaim.freestanding[2], true)
    ui.set_visible(antiaim.roll, true)
end)